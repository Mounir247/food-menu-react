...
import styles from './SaladSummary.module.css'
import Aux from '../../../../hoc/Auxiliary/Auxiliary';
import {saladsMedia} from '../SaladsItems'
import Button from '../../../UI/Button/Button';
import {Link} from 'react-router-dom'

class SaladSummary extends Component {
    ...
    render () {
      ...
      const item = saladsMedia.find(item => item.id === this.props.id);
