...
import styles from './BreakFastSummary.module.css'
import Aux from '../../../../hoc/Auxiliary/Auxiliary';
import {breakfastMedia} from '../BreakFastItems'
import Button from '../../../UI/Button/Button';
import {Link} from 'react-router-dom'

class BreakFastSummary extends Component {
    ...
    render () {
      ...
      const item = breakfastMedia.find(item => item.id === this.props.id);
...
export default BreakFastSummary;