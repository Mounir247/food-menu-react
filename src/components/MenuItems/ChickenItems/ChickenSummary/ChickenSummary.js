...
import styles from './ChickenSummary.module.css'
import Button from '../../../UI/Button/Button';
import {Link} from 'react-router-dom'
import {chickenMedia} from '../ChickenItems'


class ChickenSummary extends Component {
    ...
    render () {
      ...
      const item = chickenMedia.find(item => item.id === this.props.id);
